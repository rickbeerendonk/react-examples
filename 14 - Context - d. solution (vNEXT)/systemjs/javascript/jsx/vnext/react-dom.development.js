...
var ReactFiberClassComponent = function (scheduleWork, computeExpirationForFiber, memoizeProps, memoizeState) {
  ...
  function updateClassInstance(current, workInProgress, renderExpirationTime) {
    ...
    if ((typeof instance.UNSAFE_componentWillReceiveProps === 'function' || typeof instance.componentWillReceiveProps === 'function') && (oldProps !== newProps || oldContext !== newContext)) {
      ...
      while (_fiber !== null) {
        ...
        switch (_fiber.tag) {
          ...
          case ContextProvider:
            ...
            nextFiber = _fiber.type === workInProgress.type ? null : _fiber.child;
            break;
          default:
            // Traverse down.
            nextFiber = _fiber.child;
    ...
    if (enableNewContextAPI) {
      ...
      if (oldProps === null) {
        ...
        if (oldValue === newValue && (oldValue !== 0 || 1 / oldValue === 1 / newValue) || oldValue !== oldValue && newValue !== newValue // eslint-disable-line no-self-compare
          ...
          changedBits = context.calculateChangedBits !== null ? context.calculateChangedBits(oldValue, newValue) : MAX_SIGNED_31_BIT_INT;
          {
