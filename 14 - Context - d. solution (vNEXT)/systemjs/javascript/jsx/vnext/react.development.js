...
function createContext(defaultValue, calculateChangedBits) {
  ...
  var context = {
    ...
    provide: function (value, children, key) {
      return {
        $$typeof: REACT_ELEMENT_TYPE,
        type: providerType,
    ...
    consume: function (render, observedBits, key) {
      return {
        $$typeof: REACT_ELEMENT_TYPE,
        type: context,
        key: key === null || key === undefined ? null : '' + key,
...
function createElementWithValidation(type, props, children) {
  ...
  type === REACT_FRAGMENT_TYPE || type === REACT_STRICT_MODE_TYPE;
