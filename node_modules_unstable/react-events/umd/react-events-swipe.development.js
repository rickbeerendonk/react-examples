...
function dispatchSwipeEvent(context, name, listener, state, eventPriority, eventData) {
      ...
      case 'pointermove':
        {
          ...
          if (state.isSwiping) {
            ...
            if (props.onSwipeMove) {
              ...
              dispatchSwipeEvent(context, 'swipemove', props.onSwipeMove, state, UserBlockingEvent, eventData);
          ...
          if (state.isSwiping) {
            ...
            if (_direction !== _lastDirection) {
              if (props.onSwipeLeft && _direction === 3) {
                dispatchSwipeEvent(context, 'swipeleft', props.onSwipeLeft, state, DiscreteEvent);
              } else if (props.onSwipeRight && _direction === 1) {
                dispatchSwipeEvent(context, 'swiperight', props.onSwipeRight, state, DiscreteEvent);
              }
            }
            if (props.onSwipeEnd) {
              dispatchSwipeEvent(context, 'swipeend', props.onSwipeEnd, state, DiscreteEvent);
            }
