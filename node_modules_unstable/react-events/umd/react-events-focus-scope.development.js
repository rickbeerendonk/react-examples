 ...
 * react-events-focus-scope.development.js
 *
...
(function (global, factory) {
	...
	(global.ReactEventsFocusScope = factory(global.React));
}(this, (function (React) { 'use strict';

var targetEventTypes = [{ name: 'keydown', passive: false }];
var rootEventTypes = [{ name: 'focus', passive: true }];
...
var FocusScopeResponder = {
  ...
  onEvent: function (event, context, props, state) {
    ...
    if (type === 'keydown' && nativeEvent.key === 'Tab') {
      ...
      if (focusedElement !== null && context.isTargetWithinEventComponent(focusedElement)) {
...
var FocusScope$1 = Object.freeze({
	default: FocusScope
});
