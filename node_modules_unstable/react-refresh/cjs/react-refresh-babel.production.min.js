...
e=!0});a=[a,f.stringLiteral(c)];(e||0<g.length)&&a.push(f.booleanLiteral(e));0<g.length&&a.push(f.functionExpression(null,[],f.blockStatement([f.returnStatement(f.arrayExpression(g))])));return a}if("function"===typeof q.getEnv){var y=q.getEnv();if("development"!==y)throw Error('React Refresh Babel transform should only be enabled in development environment. Instead, the environment is: "'+y+'".');}var f=q.types,l=new Map,x=new WeakMap,k=new WeakSet,p=new WeakSet,z=new WeakSet,n=new WeakMap,D={CallExpression:function(a){var b=
a.node.callee,d=null;switch(b.type){case "Identifier":d=b.name;break;case "MemberExpression":d=b.property.name}if(null!==d&&/^use[A-Z]/.test(d)&&(b=a.scope.getFunctionParent(),null!==b)){b=b.block;n.has(b)||n.set(b,[]);b=n.get(b);var c="";"VariableDeclarator"===a.parent.type&&(c=a.parentPath.get("id").getSource());var e=a.get("arguments");"useState"===d&&0<e.length?c+="("+e[0].getSource()+")":"useReducer"===d&&1<e.length&&(c+="("+e[1].getSource()+")");b.push({callee:a.node.callee,name:d,key:c})}}};
...
a.parentPath;d=c.parentPath;break;default:return}var e=b.id;null!==e&&(e=e.name,t(e)&&!k.has(b)&&(k.add(b),m(e,a,function(a,b){a=r(d,a);c.insertAfter(f.expressionStatement(f.assignmentExpression("=",a,b)))})))},exit:function(a){var b=a.node,d=b.id;if(null!==d){var c=w(b);if(null!==c&&!p.has(b)){p.add(b);b=a.scope.generateUidIdentifier("_s");a.scope.parent.push({id:b,init:f.callExpression(f.identifier("$RefreshSig$"),[])});a.get("body").unshiftContainer("body",f.expressionStatement(f.callExpression(b,
[])));var e=null;a.find(function(a){if(a.parentPath.isBlock())return e=a,!0});null!==e&&e.insertAfter(f.expressionStatement(f.callExpression(b,u(d,c,e.scope))))}}}},"ArrowFunctionExpression|FunctionExpression":{exit:function(a){var b=a.node,d=w(b);if(null!==d&&!p.has(b)){p.add(b);var c=a.scope.generateUidIdentifier("_s");a.scope.parent.push({id:c,init:f.callExpression(f.identifier("$RefreshSig$"),[])});a.get("body").unshiftContainer("body",f.expressionStatement(f.callExpression(c,[])));if("VariableDeclarator"===
a.parent.type){var e=null;a.find(function(a){if(a.parentPath.isBlock())return e=a,!0});null!==e&&e.insertAfter(f.expressionStatement(f.callExpression(c,u(a.parent.id,d,e.scope))))}else a.replaceWith(f.callExpression(c,u(b,d,a.scope)))}}},VariableDeclaration:function(a){var b=a.node,d=void 0,c=void 0;switch(a.parent.type){case "Program":c=a;d=a.parentPath;break;case "ExportNamedDeclaration":c=a.parentPath;d=c.parentPath;break;case "ExportDefaultDeclaration":c=a.parentPath;d=c.parentPath;break;default:return}if(!k.has(b)&&
(k.add(b),a=a.get("declarations"),1===a.length)){var e=a[0];m(e.node.id.name,e,function(a,b,h){null!==h&&(a=r(d,a),"ArrowFunctionExpression"!==b.type&&"FunctionExpression"!==b.type||"VariableDeclarator"!==h.parent.type?h.replaceWith(f.assignmentExpression("=",a,b)):c.insertAfter(f.expressionStatement(f.assignmentExpression("=",a,e.node.id))))})}},Program:{enter:function(a){a.traverse(D)},exit:function(a){var b=l.get(a);if(void 0!==b){var d=a.node;if(!z.has(d)){z.add(d);l.delete(a);var c=[];a.pushContainer("body",
f.variableDeclaration("var",c));b.forEach(function(b){var d=b.handle;b=b.persistentID;a.pushContainer("body",f.expressionStatement(f.callExpression(f.identifier("$RefreshReg$"),[d,f.stringLiteral(b)])));c.push(f.variableDeclarator(d))})}}}}}}}var A={default:v},B=A&&v||A;module.exports=B.default||B;
