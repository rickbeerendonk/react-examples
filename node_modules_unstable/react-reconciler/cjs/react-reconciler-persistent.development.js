...
var shouldWarnUnactedUpdates = $$$hostConfig.shouldWarnUnactedUpdates;
...
function updateEventComponentInstance(eventComponent, props) {
  ...
  if (currentEventComponentInstanceIndex === events.length) {
    ...
    var eventComponentInstance = createEventComponentInstance(currentlyRenderingFiber$2, props, responder, null, responderState || {}, true);
    ...
    _eventComponentInstance.currentFiber = currentlyRenderingFiber$2;
  }
}
        ...
        if ((workInProgress.effectTag & DidCapture) === NoEffect) {
          ...
          if (suspenseListState === null || suspenseListState.rendering === null) {
            ...
            if (!suspenseListState.didSuspend) {
              if (now$1() > suspenseListState.tailExpiration && renderExpirationTime > Never) {
          ...
          if (suspenseListState !== null && suspenseListState.tail !== null) {
            ...
            if (suspenseListState.tailExpiration === 0) {
              ...
              suspenseListState.tailExpiration = now$1() + TAIL_EXPIRATION_TIMEOUT_MS;
            }
            // Pop a row.
...
var ReactFiberReconciler = Object.freeze({
	...
	ReactActingRendererSigil: ReactActingRendererSigil,
