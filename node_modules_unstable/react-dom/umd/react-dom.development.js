...
var enableFundamentalAPI = true; // Experimental Scope support.

var enableScopeAPI = true; // New API for JSX transforms to target - https://github.com/reactjs/rfcs/pull/107
...
var enableSuspenseCallback = true; // Part of the simplification of React.createElement so we can eventually move
...
var enableTrustedTypesIntegration = true;
...
function createRoot(container, options) {
  ...
  if (!isValidContainer(container)) {
    {
      throw Error(functionName + "(...): Target container is not a DOM element.");
    }
  }
