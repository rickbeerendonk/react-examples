 ...
 */
'use strict';(function(r,v){"object"===typeof exports&&"undefined"!==typeof module?module.exports=v(require("react")):"function"===typeof define&&define.amd?define(["react"],v):r.ReactDOMServer=v(r.React)})(this,function(r){function v(a,b,d,c,m,g,k,da){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var e=[d,c,m,g,k,da],n=0;a=Error(b.replace(/%s/g,function(){return e[n++]}));
a.name="Invariant Violation"}a.framesToPop=1;throw a;}}function t(a){for(var b=arguments.length-1,d="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=0;c<b;c++)d+="&args[]="+encodeURIComponent(arguments[c+1]);v(!1,"Minified React error #"+a+"; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ",d)}function A(a){if(null==a)return null;if("function"===typeof a)return a.displayName||a.name||null;if("string"===typeof a)return a;
...
c.props,f.state);null!=e&&(f.state=w({},f.state,e))}}else if(f=d(c.props,m,h),null==f||null==f.render){a=f;X(a,d);return}f.props=c.props;f.context=m;f.updater=h;h=f.state;void 0===h&&(f.state=h=null);if("function"===typeof f.UNSAFE_componentWillMount||"function"===typeof f.componentWillMount)if("function"===typeof f.componentWillMount&&"function"!==typeof d.getDerivedStateFromProps&&f.componentWillMount(),"function"===typeof f.UNSAFE_componentWillMount&&"function"!==typeof d.getDerivedStateFromProps&&
f.UNSAFE_componentWillMount(),g.length){h=g;var n=k;g=null;k=!1;if(n&&1===h.length)f.state=h[0];else{e=n?h[0]:f.state;var l=!0;for(n=n?1:0;n<h.length;n++){var q=h[n];q="function"===typeof q?q.call(f,e,c.props,m):q;null!=q&&(l?(l=!1,e=w({},e,q)):w(e,q))}f.state=e}}else g=null;a=f.render();X(a,d);c=void 0;if("function"===typeof f.getChildContext&&(m=d.childContextTypes,"object"===typeof m)){c=f.getChildContext();for(var p in c)p in m?void 0:t("108",A(d)||"Unknown",p)}c&&(b=w({},b,c))}for(;r.isValidElement(a);){var c=
a,m=c.type;if("function"!==typeof m)break;d(c,m)}return{child:a,context:b}}var w=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.assign,e="function"===typeof Symbol&&Symbol.for,J=e?Symbol.for("react.portal"):60106,D=e?Symbol.for("react.fragment"):60107,L=e?Symbol.for("react.strict_mode"):60108,K=e?Symbol.for("react.profiler"):60114,E=e?Symbol.for("react.provider"):60109,N=e?Symbol.for("react.context"):60110,I=e?Symbol.for("react.concurrent_mode"):60111,O=e?Symbol.for("react.forward_ref"):60112,
...
void 0;t("258",b.toString())}a=x(a);this.stack.push({type:null,domNamespace:c,children:a,childIndex:0,context:d,footer:""});return""}b=a.type;if("string"===typeof b)return this.renderDOM(a,d,c);switch(b){case L:case I:case K:case D:return a=x(a.props.children),this.stack.push({type:null,domNamespace:c,children:a,childIndex:0,context:d,footer:""}),"";case M:v(!1,"ReactDOMServer does not yet support Suspense.")}if("object"===typeof b&&null!==b)switch(b.$$typeof){case O:return a=x(b.render(a.props,a.ref)),
this.stack.push({type:null,domNamespace:c,children:a,childIndex:0,context:d,footer:""}),"";case P:return a=[r.createElement(b.type,w({ref:a.ref},a.props))],this.stack.push({type:null,domNamespace:c,children:a,childIndex:0,context:d,footer:""}),"";case E:return b=x(a.props.children),c={type:a,domNamespace:c,children:b,childIndex:0,context:d,footer:""},this.pushProvider(a),this.stack.push(c),"";case N:return b=x(a.props.children(a.type._currentValue)),this.stack.push({type:a,domNamespace:c,children:b,
childIndex:0,context:d,footer:""}),"";case Q:v(!1,"ReactDOMServer does not yet support lazy-loaded components.")}t("130",null==b?b:typeof b,"")};a.prototype.renderDOM=function(a,d,c){var b=a.type.toLowerCase();"http://www.w3.org/1999/xhtml"===c&&V(b);aa.hasOwnProperty(b)||(sa.test(b)?void 0:t("65",b),aa[b]=!0);var g=a.props;if("input"===b)g=w({type:void 0},g,{defaultChecked:void 0,defaultValue:void 0,value:null!=g.value?g.value:g.defaultValue,checked:null!=g.checked?g.checked:g.defaultChecked});else if("textarea"===
b){var k=g.value;if(null==k){k=g.defaultValue;var e=g.children;null!=e&&(null!=k?t("92"):void 0,Array.isArray(e)&&(1>=e.length?void 0:t("93"),e=e[0]),k=""+e);null==k&&(k="")}g=w({},g,{value:void 0,children:""+k})}else if("select"===b)this.currentSelectValue=null!=g.value?g.value:g.defaultValue,g=w({},g,{value:void 0});else if("option"===b){e=this.currentSelectValue;var p=ja(g.children);if(null!=e){var r=null!=g.value?g.value+"":p;k=!1;if(Array.isArray(e))for(var h=0;h<e.length;h++){if(""+e[h]===r){k=
!0;break}}else k=""+e===r;g=w({selected:void 0,children:void 0},g,{selected:k,children:p})}}if(k=g)ma[b]&&(null!=k.children||null!=k.dangerouslySetInnerHTML?t("137",b,""):void 0),null!=k.dangerouslySetInnerHTML&&(null!=k.children?t("60"):void 0,"object"===typeof k.dangerouslySetInnerHTML&&"__html"in k.dangerouslySetInnerHTML?void 0:t("61")),null!=k.style&&"object"!==typeof k.style?t("62",""):void 0;k=g;e=this.makeStaticMarkup;p=1===this.stack.length;r="<"+a.type;for(u in k)if(ta.call(k,u)){var f=
k[u];if(null!=f){if("style"===u){h=void 0;var v="",B="";for(h in f)if(f.hasOwnProperty(h)){var l=0===h.indexOf("--"),q=f[h];if(null!=q){var z=h;if(H.hasOwnProperty(z))z=H[z];else{var A=z.replace(oa,"-$1").toLowerCase().replace(pa,"-ms-");z=H[z]=A}v+=B+z+":";B=h;l=null==q||"boolean"===typeof q||""===q?"":l||"number"!==typeof q||0===q||C.hasOwnProperty(B)&&C[B]?(""+q).trim():q+"px";v+=l;B=";"}}f=v||null}h=null;b:if(l=b,q=k,-1===l.indexOf("-"))l="string"===typeof q.is;else switch(l){case "annotation-xml":case "color-profile":case "font-face":case "font-face-src":case "font-face-uri":case "font-face-format":case "font-face-name":case "missing-glyph":l=
...
!1;return u};return a}();e={renderToString:function(a){return(new ba(a,!1)).read(Infinity)},renderToStaticMarkup:function(a){return(new ba(a,!0)).read(Infinity)},renderToNodeStream:function(){t("207")},renderToStaticNodeStream:function(){t("208")},version:"16.6.0-beta.0"};var ca={default:e};e=ca&&e||ca;return e.default||e});
